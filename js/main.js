...
(function () {
  ...
  const SEARCH_INDEX = [
    ...
    { title: "808", url: "/bible/808.html", tags: "808 production bible reference production" },
    { title: "Additive Synthesis", url: "/bible/additive-synthesis.html", tags: "additive synthesis synthesis bible reference production" },
    { title: "ADSR", url: "/bible/adsr.html", tags: "adsr synthesis bible reference production" },
    { title: "Air Frequency", url: "/bible/air.html", tags: "air frequency frequency bible reference production" },
    { title: "Air Frequency EQ", url: "/bible/air-frequency-eq.html", tags: "air frequency eq frequency bible reference production" },
    { title: "Analog", url: "/bible/analog.html", tags: "analog signal processing bible reference production" },
    { title: "Arpeggiator", url: "/bible/arpeggiator.html", tags: "arpeggiator synthesis bible reference production" },
    { title: "Arrangement", url: "/bible/arrangement.html", tags: "arrangement music theory bible reference production" },
    { title: "Attack", url: "/bible/attack.html", tags: "attack dynamics bible reference production" },
    { title: "Attack and Release", url: "/bible/attack-release.html", tags: "attack and release dynamics bible reference production" },
    { title: "Audio Interface", url: "/bible/audio-interface.html", tags: "audio interface recording bible reference production" },
    { title: "Audio Routing", url: "/bible/audio-routing.html", tags: "audio routing mixing bible reference production" },
    { title: "Audio Track", url: "/bible/audio-track.html", tags: "audio track mixing bible reference production" },
    { title: "Automation", url: "/bible/automation.html", tags: "automation mixing bible reference production" },
    { title: "Automation Clip", url: "/bible/automation-clip.html", tags: "automation clip production bible reference production" },
    { title: "Aux Send", url: "/bible/aux-send.html", tags: "aux send mixing bible reference production" },
    { title: "Beat Making", url: "/bible/beat-making.html", tags: "beat making production bible reference production" },
    { title: "Bell Curve", url: "/bible/bell-curve.html", tags: "bell curve frequency bible reference production" },
    { title: "Bit Depth", url: "/bible/bit-depth.html", tags: "bit depth signal processing bible reference production" },
    { title: "Boom Bap", url: "/bible/boom-bap.html", tags: "boom bap production bible reference production" },
    { title: "Bounce", url: "/bible/bounce.html", tags: "bounce mixing bible reference production" },
    { title: "BPM", url: "/bible/bpm.html", tags: "bpm music theory bible reference production" },
    { title: "Breakdown", url: "/bible/breakdown.html", tags: "breakdown music theory bible reference production" },
    { title: "Bridge", url: "/bible/bridge.html", tags: "bridge music theory bible reference production" },
    { title: "Buffer Size", url: "/bible/buffer-size.html", tags: "buffer size recording bible reference production" },
    { title: "Bus", url: "/bible/bus.html", tags: "bus mixing bible reference production" },
    { title: "Bus Compression", url: "/bible/bus-compression.html", tags: "bus compression dynamics bible reference production" },
    { title: "Call and Response", url: "/bible/call-and-response.html", tags: "call and response music theory bible reference production" },
    { title: "Chop", url: "/bible/chop.html", tags: "chop production bible reference production" },
    { title: "Chord", url: "/bible/chord.html", tags: "chord music theory bible reference production" },
    { title: "Chord Progression", url: "/bible/chord-progression.html", tags: "chord progression music theory bible reference production" },
    { title: "Chorus", url: "/bible/chorus.html", tags: "chorus time-based bible reference production" },
    { title: "Chorus", url: "/bible/chorus-section.html", tags: "chorus music theory bible reference production" },
    { title: "Clip", url: "/bible/clip.html", tags: "clip recording bible reference production" },
    { title: "Clip Gain", url: "/bible/clip-gain.html", tags: "clip gain signal processing bible reference production" },
    { title: "Clipping", url: "/bible/clipping.html", tags: "clipping signal processing bible reference production" },
    { title: "Clocking", url: "/bible/clocking.html", tags: "clocking signal processing bible reference production" },
    { title: "Compression", url: "/bible/compression.html", tags: "compression dynamics bible reference production" },
    { title: "Compression Ratio", url: "/bible/compression-ratio.html", tags: "compression ratio dynamics bible reference production" },
    { title: "Condenser Microphone", url: "/bible/condenser-microphone.html", tags: "condenser microphone recording bible reference production" },
    { title: "Convolution Reverb", url: "/bible/convolution-reverb.html", tags: "convolution reverb time-based bible reference production" },
    { title: "DAW", url: "/bible/daw.html", tags: "daw production bible reference production" },
    { title: "DAW Workflow", url: "/bible/daw-workflow.html", tags: "daw workflow production bible reference production" },
    { title: "dBFS", url: "/bible/dbfs.html", tags: "dbfs signal processing bible reference production" },
    { title: "De-Esser", url: "/bible/de-esser.html", tags: "de-esser dynamics bible reference production" },
    { title: "Decay", url: "/bible/decay.html", tags: "decay synthesis bible reference production" },
    { title: "Delay", url: "/bible/delay.html", tags: "delay time-based bible reference production" },
    { title: "Detune", url: "/bible/detune.html", tags: "detune synthesis bible reference production" },
    { title: "DI Box", url: "/bible/di-box.html", tags: "di box recording bible reference production" },
    { title: "Digital", url: "/bible/digital.html", tags: "digital signal processing bible reference production" },
    { title: "Distortion", url: "/bible/distortion.html", tags: "distortion signal processing bible reference production" },
    { title: "Dithering", url: "/bible/dithering.html", tags: "dithering mastering bible reference production" },
    { title: "Drill", url: "/bible/drill.html", tags: "drill production bible reference production" },
    { title: "Drop", url: "/bible/drop.html", tags: "drop music theory bible reference production" },
    { title: "Dynamic EQ", url: "/bible/dynamic-eq.html", tags: "dynamic eq dynamics bible reference production" },
    { title: "Dynamic Microphone", url: "/bible/dynamic-microphone.html", tags: "dynamic microphone recording bible reference production" },
    { title: "Dynamic Range", url: "/bible/dynamic-range.html", tags: "dynamic range dynamics bible reference production" },
    { title: "Envelope", url: "/bible/envelope.html", tags: "envelope synthesis bible reference production" },
    { title: "Eq", url: "/bible/eq.html", tags: "eq frequency bible reference production" },
    { title: "Exciter", url: "/bible/exciter.html", tags: "exciter dynamics bible reference production" },
    { title: "Expansion", url: "/bible/expansion.html", tags: "expansion dynamics bible reference production" },
    { title: "Fader", url: "/bible/fader.html", tags: "fader mixing bible reference production" },
    { title: "Feedback", url: "/bible/feedback.html", tags: "feedback signal processing bible reference production" },
    { title: "FET Compressor", url: "/bible/fet-compressor.html", tags: "fet compressor dynamics bible reference production" },
    { title: "Filter", url: "/bible/filter.html", tags: "filter frequency bible reference production" },
    { title: "Flanger", url: "/bible/flanger.html", tags: "flanger time-based bible reference production" },
    { title: "FM Synthesis", url: "/bible/fm-synthesis.html", tags: "fm synthesis synthesis bible reference production" },
    { title: "Freeze", url: "/bible/freeze.html", tags: "freeze mixing bible reference production" },
    { title: "Frequency", url: "/bible/frequency.html", tags: "frequency frequency bible reference production" },
    { title: "Frequency Masking", url: "/bible/frequency-masking.html", tags: "frequency masking frequency bible reference production" },
    { title: "Fundamental Frequency", url: "/bible/fundamental.html", tags: "fundamental frequency frequency bible reference production" },
    { title: "Gain", url: "/bible/gain.html", tags: "gain signal processing bible reference production" },
    { title: "Gain Reduction", url: "/bible/gain-reduction.html", tags: "gain reduction dynamics bible reference production" },
    { title: "Gain Staging", url: "/bible/gain-staging.html", tags: "gain staging mixing bible reference production" },
    { title: "Gain Structure", url: "/bible/gain-structure.html", tags: "gain structure mixing bible reference production" },
    { title: "Glue", url: "/bible/glue.html", tags: "glue mixing bible reference production" },
    { title: "Granular Synthesis", url: "/bible/granular-synthesis.html", tags: "granular synthesis synthesis bible reference production" },
    { title: "Graphic EQ", url: "/bible/graphic-eq.html", tags: "graphic eq frequency bible reference production" },
    { title: "Groove", url: "/bible/groove.html", tags: "groove music theory bible reference production" },
    { title: "Hall Reverb", url: "/bible/hall-reverb.html", tags: "hall reverb time-based bible reference production" },
    { title: "Harmonic", url: "/bible/harmonic.html", tags: "harmonic signal processing bible reference production" },
    { title: "Harmonic Distortion", url: "/bible/harmonic-distortion.html", tags: "harmonic distortion frequency bible reference production" },
    { title: "Harmony", url: "/bible/harmony.html", tags: "harmony music theory bible reference production" },
    { title: "Headroom", url: "/bible/headroom.html", tags: "headroom mixing bible reference production" },
    { title: "High-Pass Filter", url: "/bible/high-pass-filter.html", tags: "high-pass filter frequency bible reference production" },
    { title: "Hook", url: "/bible/hook.html", tags: "hook music theory bible reference production" },
    { title: "Humanization", url: "/bible/humanization.html", tags: "humanization mixing bible reference production" },
    { title: "Impedance", url: "/bible/impedance.html", tags: "impedance signal processing bible reference production" },
    { title: "Instrument Track", url: "/bible/instrument-track.html", tags: "instrument track mixing bible reference production" },
    { title: "Integrated Loudness", url: "/bible/integrated-loudness.html", tags: "integrated loudness mastering bible reference production" },
    { title: "Interval", url: "/bible/interval.html", tags: "interval music theory bible reference production" },
    { title: "Intro", url: "/bible/intro.html", tags: "intro music theory bible reference production" },
    { title: "Key", url: "/bible/key.html", tags: "key music theory bible reference production" },
    { title: "Knee", url: "/bible/knee.html", tags: "knee dynamics bible reference production" },
    { title: "Latency", url: "/bible/latency.html", tags: "latency recording bible reference production" },
    { title: "Layering", url: "/bible/layering.html", tags: "layering mixing bible reference production" },
    { title: "LFO", url: "/bible/lfo.html", tags: "lfo synthesis bible reference production" },
    { title: "Limiting", url: "/bible/limiting.html", tags: "limiting dynamics bible reference production" },
    { title: "Linear Phase EQ", url: "/bible/linear-phase-eq.html", tags: "linear phase eq frequency bible reference production" },
    { title: "Lo-Fi", url: "/bible/lo-fi.html", tags: "lo-fi production bible reference production" },
    { title: "Loudness", url: "/bible/loudness.html", tags: "loudness mastering bible reference production" },
    { title: "Loudness Matching", url: "/bible/loudness-matching.html", tags: "loudness matching mixing bible reference production" },
    { title: "Loudness Normalization", url: "/bible/loudness-normalization.html", tags: "loudness normalization mastering bible reference production" },
    { title: "Loudness War", url: "/bible/loudness-war.html", tags: "loudness war mastering bible reference production" },
    { title: "Low-Pass Filter", url: "/bible/low-pass-filter.html", tags: "low-pass filter frequency bible reference production" },
    { title: "LUFS", url: "/bible/lufs.html", tags: "lufs mastering bible reference production" },
    { title: "Makeup Gain", url: "/bible/makeup-gain.html", tags: "makeup gain dynamics bible reference production" },
    { title: "Master Limiter", url: "/bible/master-limiter.html", tags: "master limiter dynamics bible reference production" },
    { title: "Mastering", url: "/bible/mastering.html", tags: "mastering mastering bible reference production" },
    { title: "Melody", url: "/bible/melody.html", tags: "melody music theory bible reference production" },
    { title: "Meter", url: "/bible/meter.html", tags: "meter music theory bible reference production" },
    { title: "Microphone Placement", url: "/bible/microphone-placement.html", tags: "microphone placement recording bible reference production" },
    { title: "Mid-Side EQ", url: "/bible/mid-side-eq.html", tags: "mid-side eq frequency bible reference production" },
    { title: "Mid-Side Processing", url: "/bible/mid-side-processing.html", tags: "mid-side processing mixing bible reference production" },
    { title: "MIDI", url: "/bible/midi.html", tags: "midi production bible reference production" },
    { title: "Mix Bus", url: "/bible/mix-bus.html", tags: "mix bus mixing bible reference production" },
    { title: "Mix Translation", url: "/bible/mix-translation.html", tags: "mix translation mixing bible reference production" },
    { title: "Mixing", url: "/bible/mixing.html", tags: "mixing mixing bible reference production" },
    { title: "Mode", url: "/bible/mode.html", tags: "mode music theory bible reference production" },
    { title: "Modulation", url: "/bible/modulation.html", tags: "modulation time-based bible reference production" },
    { title: "Mono Compatibility", url: "/bible/mono-compatibility.html", tags: "mono compatibility mixing bible reference production" },
    { title: "Mud", url: "/bible/mud.html", tags: "mud frequency bible reference production" },
    { title: "Multiband Compression", url: "/bible/multiband-compression.html", tags: "multiband compression dynamics bible reference production" },
    { title: "Music Theory", url: "/bible/music-theory.html", tags: "music theory music theory bible reference production" },
    { title: "Noise Floor", url: "/bible/noise-floor.html", tags: "noise floor signal processing bible reference production" },
    { title: "Noise Gate", url: "/bible/noise-gate.html", tags: "noise gate dynamics bible reference production" },
    { title: "Notch Filter", url: "/bible/notch-filter.html", tags: "notch filter frequency bible reference production" },
    { title: "Octave", url: "/bible/octave.html", tags: "octave music theory bible reference production" },
    { title: "Optical Compressor", url: "/bible/optical-compressor.html", tags: "optical compressor dynamics bible reference production" },
    { title: "Oscillator", url: "/bible/oscillator.html", tags: "oscillator synthesis bible reference production" },
    { title: "Outro", url: "/bible/outro.html", tags: "outro music theory bible reference production" },
    { title: "Overdrive", url: "/bible/overdrive.html", tags: "overdrive signal processing bible reference production" },
    { title: "Panning", url: "/bible/panning.html", tags: "panning mixing bible reference production" },
    { title: "Parallel Compression", url: "/bible/parallel-compression.html", tags: "parallel compression dynamics bible reference production" },
    { title: "Parallel Processing", url: "/bible/parallel-processing.html", tags: "parallel processing mixing bible reference production" },
    { title: "Parametric EQ", url: "/bible/parametric-eq.html", tags: "parametric eq frequency bible reference production" },
    { title: "Patch", url: "/bible/patch.html", tags: "patch mixing bible reference production" },
    { title: "PDC", url: "/bible/pdc.html", tags: "pdc recording bible reference production" },
    { title: "Peak", url: "/bible/peak.html", tags: "peak signal processing bible reference production" },
    { title: "Phantom Power", url: "/bible/phantom-power.html", tags: "phantom power recording bible reference production" },
    { title: "Phase", url: "/bible/phase.html", tags: "phase signal processing bible reference production" },
    { title: "Phase Cancellation", url: "/bible/phase-cancellation.html", tags: "phase cancellation signal processing bible reference production" },
    { title: "Phaser", url: "/bible/phaser.html", tags: "phaser time-based bible reference production" },
    { title: "Phonk", url: "/bible/phonk.html", tags: "phonk production bible reference production" },
    { title: "Ping-Pong Delay", url: "/bible/ping-pong-delay.html", tags: "ping-pong delay time-based bible reference production" },
    { title: "Pitch", url: "/bible/pitch.html", tags: "pitch music theory bible reference production" },
    { title: "Pitch Shifting", url: "/bible/pitch-shifting.html", tags: "pitch shifting time-based bible reference production" },
    { title: "Plate Reverb", url: "/bible/plate-reverb.html", tags: "plate reverb time-based bible reference production" },
    { title: "Plugin", url: "/bible/plugin.html", tags: "plugin synthesis bible reference production" },
    { title: "Polar Pattern", url: "/bible/polar-pattern.html", tags: "polar pattern recording bible reference production" },
    { title: "Polyrhythm", url: "/bible/polyrhythm.html", tags: "polyrhythm music theory bible reference production" },
    { title: "Portamento", url: "/bible/portamento.html", tags: "portamento synthesis bible reference production" },
    { title: "Pre-Delay", url: "/bible/pre-delay.html", tags: "pre-delay time-based bible reference production" },
    { title: "Preamp", url: "/bible/preamp.html", tags: "preamp recording bible reference production" },
    { title: "Presence", url: "/bible/presence.html", tags: "presence frequency bible reference production" },
    { title: "Q Factor", url: "/bible/q-factor.html", tags: "q factor frequency bible reference production" },
    { title: "Quantization", url: "/bible/quantization.html", tags: "quantization production bible reference production" },
    { title: "Ratio", url: "/bible/ratio.html", tags: "ratio dynamics bible reference production" },
    { title: "Recording", url: "/bible/recording.html", tags: "recording recording bible reference production" },
    { title: "Reference Mastering", url: "/bible/reference-mastering.html", tags: "reference mastering mastering bible reference production" },
    { title: "Reference Track", url: "/bible/reference-track.html", tags: "reference track mixing bible reference production" },
    { title: "Release", url: "/bible/release.html", tags: "release dynamics bible reference production" },
    { title: "Resonance", url: "/bible/resonance.html", tags: "resonance frequency bible reference production" },
    { title: "Return Track", url: "/bible/return-track.html", tags: "return track mixing bible reference production" },
    { title: "Reverb", url: "/bible/reverb.html", tags: "reverb time-based bible reference production" },
    { title: "Rhythm", url: "/bible/rhythm.html", tags: "rhythm music theory bible reference production" },
    { title: "RMS", url: "/bible/rms.html", tags: "rms signal processing bible reference production" },
    { title: "Room Reverb", url: "/bible/room-reverb.html", tags: "room reverb time-based bible reference production" },
    { title: "Sample Flip", url: "/bible/sample-flip.html", tags: "sample flip production bible reference production" },
    { title: "Sample Rate", url: "/bible/sample-rate.html", tags: "sample rate signal processing bible reference production" },
    { title: "Sampling", url: "/bible/sampling.html", tags: "sampling production bible reference production" },
    { title: "Saturation", url: "/bible/saturation.html", tags: "saturation signal processing bible reference production" },
    { title: "Scale", url: "/bible/scale.html", tags: "scale music theory bible reference production" },
    { title: "Send and Return", url: "/bible/send-return.html", tags: "send and return mixing bible reference production" },
    { title: "Shelf EQ", url: "/bible/shelf.html", tags: "shelf eq frequency bible reference production" },
    { title: "Shelving EQ", url: "/bible/shelving-eq.html", tags: "shelving eq frequency bible reference production" },
    { title: "Shimmer Reverb", url: "/bible/shimmer-reverb.html", tags: "shimmer reverb time-based bible reference production" },
    { title: "Short-Term Loudness", url: "/bible/short-term-loudness.html", tags: "short-term loudness mastering bible reference production" },
    { title: "Sidechain", url: "/bible/sidechain.html", tags: "sidechain dynamics bible reference production" },
    { title: "Sidechain Compression", url: "/bible/sidechain-compression.html", tags: "sidechain compression dynamics bible reference production" },
    { title: "Signal Chain", url: "/bible/signal-chain.html", tags: "signal chain mixing bible reference production" },
    { title: "Slapback Delay", url: "/bible/slapback-delay.html", tags: "slapback delay time-based bible reference production" },
    { title: "Sound Design", url: "/bible/sound-design.html", tags: "sound design synthesis bible reference production" },
    { title: "Space", url: "/bible/space.html", tags: "space mixing bible reference production" },
    { title: "Spring Reverb", url: "/bible/spring-reverb.html", tags: "spring reverb time-based bible reference production" },
    { title: "Stem", url: "/bible/stem.html", tags: "stem mixing bible reference production" },
    { title: "Stem Mastering", url: "/bible/stem-mastering.html", tags: "stem mastering mastering bible reference production" },
    { title: "Stereo Imaging", url: "/bible/stereo-imaging.html", tags: "stereo imaging mixing bible reference production" },
    { title: "Stereo Width", url: "/bible/stereo-width.html", tags: "stereo width mixing bible reference production" },
    { title: "Sub Frequency", url: "/bible/subfrequency.html", tags: "sub frequency frequency bible reference production" },
    { title: "Subtractive Synthesis", url: "/bible/subtractive-synthesis.html", tags: "subtractive synthesis synthesis bible reference production" },
    { title: "Summing", url: "/bible/summing.html", tags: "summing mixing bible reference production" },
    { title: "Swing", url: "/bible/swing.html", tags: "swing music theory bible reference production" },
    { title: "Syncopation", url: "/bible/syncopation.html", tags: "syncopation music theory bible reference production" },
    { title: "Tempo Sync", url: "/bible/tempo-sync.html", tags: "tempo sync music theory bible reference production" },
    { title: "Tension & Release", url: "/bible/tension-release.html", tags: "tension & release music theory bible reference production" },
    { title: "The Pocket", url: "/bible/the-pocket.html", tags: "the pocket music theory bible reference production" },
    { title: "Threshold", url: "/bible/threshold.html", tags: "threshold dynamics bible reference production" },
    { title: "Timbre", url: "/bible/timbre.html", tags: "timbre music theory bible reference production" },
    { title: "Time Signature", url: "/bible/time-signature.html", tags: "time signature music theory bible reference production" },
    { title: "Time Stretching", url: "/bible/time-stretching.html", tags: "time stretching time-based bible reference production" },
    { title: "Transient", url: "/bible/transient.html", tags: "transient dynamics bible reference production" },
    { title: "Transient Shaper", url: "/bible/transient-shaper.html", tags: "transient shaper dynamics bible reference production" },
    { title: "Transient Shaping", url: "/bible/transient-shaping.html", tags: "transient shaping dynamics bible reference production" },
    { title: "Trap", url: "/bible/trap.html", tags: "trap production bible reference production" },
    { title: "Tremolo", url: "/bible/tremolo.html", tags: "tremolo time-based bible reference production" },
    { title: "True Peak", url: "/bible/true-peak.html", tags: "true peak mastering bible reference production" },
    { title: "True Peak Limiting", url: "/bible/true-peak-limiting.html", tags: "true peak limiting mastering bible reference production" },
    { title: "Tube Compressor", url: "/bible/tube-compressor.html", tags: "tube compressor dynamics bible reference production" },
    { title: "Unison", url: "/bible/unison.html", tags: "unison synthesis bible reference production" },
    { title: "VCA Compressor", url: "/bible/vca-compressor.html", tags: "vca compressor dynamics bible reference production" },
    { title: "Velocity", url: "/bible/velocity.html", tags: "velocity synthesis bible reference production" },
    { title: "Verse", url: "/bible/verse.html", tags: "verse music theory bible reference production" },
    { title: "Vibrato", url: "/bible/vibrato.html", tags: "vibrato time-based bible reference production" },
    { title: "Vocal Production", url: "/bible/vocal-production.html", tags: "vocal production recording bible reference production" },
    { title: "Vocoder", url: "/bible/vocoder.html", tags: "vocoder synthesis bible reference production" },
    { title: "VST", url: "/bible/vst.html", tags: "vst synthesis bible reference production" },
    { title: "Waveform", url: "/bible/waveform.html", tags: "waveform signal processing bible reference production" },
    { title: "Wavetable", url: "/bible/wavetable.html", tags: "wavetable synthesis bible reference production" },
    { title: "Wavetable Synthesis", url: "/bible/wavetable-synthesis.html", tags: "wavetable synthesis synthesis bible reference production" },
    { title: "Wet/Dry", url: "/bible/wet-dry.html", tags: "wet/dry mixing bible reference production" },
    { title: "White Noise", url: "/bible/white-noise.html", tags: "white noise signal processing bible reference production" },
    { title: "808 Sub Bass Tuner", url: "/tools/808-sub-bass-tuner.html", tags: "808 sub bass tuner tool calculator reference production" },
    { title: "ADSR Visualizer", url: "/tools/adsr-visualizer.html", tags: "adsr visualizer tool calculator reference production" },
    { title: "AI Copyright Strength", url: "/tools/ai-copyright-strength.html", tags: "ai copyright strength tool calculator reference production" },
    { title: "AI Music DDEX Checker", url: "/tools/ai-music-ddex-checker.html", tags: "ai music ddex checker tool calculator reference production" },
    { title: "AI Music Rights Navigator", url: "/tools/ai-music-rights-navigator.html", tags: "ai music rights navigator tool calculator reference production" },
    { title: "Arrangement Timer", url: "/tools/arrangement-timer.html", tags: "arrangement timer tool calculator reference production" },
    { title: "Attack Release Calculator", url: "/tools/attack-release-calculator.html", tags: "attack release calculator tool calculator reference production" },
    { title: "Chord Key Reference", url: "/tools/chord-key-reference.html", tags: "chord key reference tool calculator reference production" },
    { title: "Delay Time Calculator", url: "/tools/delay-time-calculator.html", tags: "delay time calculator tool calculator reference production" },
    { title: "EQ Problem Solver", url: "/tools/eq-problem-solver.html", tags: "eq problem solver tool calculator reference production" },
    { title: "Frequency Conflict Detector", url: "/tools/frequency-conflict-detector.html", tags: "frequency conflict detector tool calculator reference production" },
    { title: "Frequency Eq Reference", url: "/tools/frequency-eq-reference.html", tags: "frequency eq reference tool calculator reference production" },
    { title: "Gain Reduction Calculator", url: "/tools/gain-reduction-calculator.html", tags: "gain reduction calculator tool calculator reference production" },
    { title: "Gain Staging Reference", url: "/tools/gain-staging-reference.html", tags: "gain staging reference tool calculator reference production" },
    { title: "Headroom Calculator", url: "/tools/headroom-calculator.html", tags: "headroom calculator tool calculator reference production" },
    { title: "LFO Sync Calculator", url: "/tools/lfo-sync-calculator.html", tags: "lfo sync calculator tool calculator reference production" },
    { title: "LUFS Target Reference", url: "/tools/lufs-target-reference.html", tags: "lufs target reference tool calculator reference production" },
    { title: "Mastering Signal Chain", url: "/tools/mastering-signal-chain.html", tags: "mastering signal chain tool calculator reference production" },
    { title: "Mix Bus Headroom Reference", url: "/tools/mix-bus-headroom-reference.html", tags: "mix bus headroom reference tool calculator reference production" },
    { title: "Mix Bus Signal Flow", url: "/tools/mix-bus-signal-flow.html", tags: "mix bus signal flow tool calculator reference production" },
    { title: "Note To Frequency", url: "/tools/note-to-frequency.html", tags: "note to frequency tool calculator reference production" },
    { title: "Parallel Processing Calculator", url: "/tools/parallel-processing-calculator.html", tags: "parallel processing calculator tool calculator reference production" },
    { title: "Pitch Correction Reference", url: "/tools/pitch-correction-reference.html", tags: "pitch correction reference tool calculator reference production" },
    { title: "Pre Delay Reverb Calculator", url: "/tools/pre-delay-reverb-calculator.html", tags: "pre delay reverb calculator tool calculator reference production" },
    { title: "Pre Delivery Checklist", url: "/tools/pre-delivery-checklist.html", tags: "pre delivery checklist tool calculator reference production" },
    { title: "Reverb Type Selector", url: "/tools/reverb-type-selector.html", tags: "reverb type selector tool calculator reference production" },
    { title: "RT60 Calculator", url: "/tools/rt60-calculator.html", tags: "rt60 calculator tool calculator reference production" },
    { title: "Sample Rate Bit Depth Guide", url: "/tools/sample-rate-bit-depth-guide.html", tags: "sample rate bit depth guide tool calculator reference production" },
    { title: "Saturation Character Reference", url: "/tools/saturation-character-reference.html", tags: "saturation character reference tool calculator reference production" },
    { title: "Saturation Harmonic Reference", url: "/tools/saturation-harmonic-reference.html", tags: "saturation harmonic reference tool calculator reference production" },
    { title: "Sidechain Compression Designer", url: "/tools/sidechain-compression-designer.html", tags: "sidechain compression designer tool calculator reference production" },
    { title: "Sidechain Ducking Reference", url: "/tools/sidechain-ducking-reference.html", tags: "sidechain ducking reference tool calculator reference production" },
    { title: "Stereo Field Mono Checker", url: "/tools/stereo-field-mono-checker.html", tags: "stereo field mono checker tool calculator reference production" },
    { title: "Stereo Width M/S", url: "/tools/stereo-width-ms.html", tags: "stereo width ms tool calculator reference production" },
    { title: "Suno Credits Calculator", url: "/tools/suno-credits-calculator.html", tags: "suno credits calculator tool calculator reference production" },
    { title: "Suno Prompt Optimizer", url: "/tools/suno-prompt-optimizer.html", tags: "suno prompt optimizer tool calculator reference production" },
    { title: "Synthesis Parameter Reference", url: "/tools/synthesis-parameter-reference.html", tags: "synthesis parameter reference tool calculator reference production" },
    { title: "Synthesis Type Selector", url: "/tools/synthesis-type-selector.html", tags: "synthesis type selector tool calculator reference production" },
    { title: "Tempo Key Chord Reference", url: "/tools/tempo-key-chord-reference.html", tags: "tempo key chord reference tool calculator reference production" },
    { title: "Transient Shaper Reference", url: "/tools/transient-shaper-reference.html", tags: "transient shaper reference tool calculator reference production" },
    { title: "Vocal Chain Builder", url: "/tools/vocal-chain-builder.html", tags: "vocal chain builder tool calculator reference production" },
  ];
